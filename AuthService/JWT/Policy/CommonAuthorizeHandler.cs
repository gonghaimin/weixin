...
{
    public class CommonAuthorizeHandler : AuthorizationHandler<PolicyRequirement>
    {
        private IHttpContextAccessor accssor;
        private IAuthContext userContext;
        private IOptions<JwtOption> jwtOption;
        public CommonAuthorizeHandler(IHttpContextAccessor accssor, IAuthContext context, IOptions<JwtOption> jwtOption)
        {
