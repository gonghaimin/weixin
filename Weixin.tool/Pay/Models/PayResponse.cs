...
namespace Weixin.Tool.Pay.Models
{
    ...
    public class AlipayPayResponse : PayResponse
    {
        /// <summary>
        /// 买家支付宝账号
        /// </summary>
    ...
    /// 支付宝预授权的响应参数
    /// </summary>
    public class AlipayFreezeResponse : FreezeResponse
    {
        /// <summary>
        /// 资金操作流水号
    ...
    /// 支付宝预授权解冻的响应参数
    /// </summary>
    public class AlipayUnFreezeResponse : UnFreezeResponse
    {
        /// <summary>
        /// 资金操作流水号
        public string OperationId { get; set; }
    ...
    public class CancelFreezeResponse
    {
        public string RetCode { get; set; }
    ...
    public class AlipayCancelFreezeResponse : CancelFreezeResponse
    {
